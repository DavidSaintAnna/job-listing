...
| :-----------------------------------------------------------------------: | :----------------------------------------------------------------------: |
| <kbd>  <img alt="project" src="/public/images/desktop.PNG" width="100%"></kbd> | <kbd><img alt="project" src="/public/images/mobile.PNG" width="100%"></kbd> |
</div>
...
Aplicação frontEnd responsiva com minha versão do desafio do frontEndMentor com renderização e consumos de uma api.json criando COMPONENTES PARA OS CARDS e filtrando os cards dipostos na tela utlizando Js de acordo com o disparo dos eventos, utilizei JS VANILLA para todo o processo. O DESAFIO É CONSIDERADO DE NIVEL INTERMEDIÁRIO https://www.frontendmentor.io/challenges/job-listings-with-filtering-ivstIPCt
